...
using Owin;
using TallerAutenticacionTelleria.Infrastructure;
using TallerAutenticacionTelleria.Models;

namespace TallerAutenticacionTelleria
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            // Inicia la creación de roles
            RoleInitializer.InitializeAsync(new ApplicationRoleManager(new RoleStore<IdentityRole>(new ApplicationDbContext()))).Wait();
